...
<form id="Product registration Form" action="love" method="post">
	<div class="fix">
		<div class="fix2">
			...
			<input type="text" name="email" placeholder="Your Email"><br><br><br>
			
			<h3>Your Product<span style='font-size:15px;'>&#10067;</span><br></h3>
			<input type="text" name="product_title" placeholder="Title"><br><br><br>
			
			<h3>Your Product Information<span style='font-size:15px;'>&#10067;</span><br></h3>
			<textarea name="product_info" style="margin:10px 0px 0px 10px; width: 500px; height: 250px; resize: none;" placeholder="Product Inpomation"></textarea><br><br><br>
			
			<h3>Your Comment<span style='font-size:15px;'>&#10067;</span><br></h3>
			<textarea name="user_comment" style="margin:10px 0px 0px 10px; width: 500px; height: 250px; resize: none;" placeholder="Comment"></textarea><br><br><br>
