    ...
    $.ajax({
    	...
    	success : function(data) {
		    ...
		    var src = '<div class="Headline">'
		        ...
		        src+= '</li>'
		        src+= '<li>'
		        src+= '<input type="button" value="PostCode" onclick="openZipSearch()" style="height: 30px;padding-left: 5px;padding-right: 5px;margin-right: 10px;margin-bottom: 10px;border-radius: 5px;background-color: white; color:black ;border: 1px solid;cursor: pointer;"><b>ADDRESS</b><br>'
		        ...
		        src+= '<input type="submit" value="Update Info" style="background-color: white; color: black;border: 1px solid;border-radius: 5px;width: 130px;height: 40px;font-size: 16px;cursor: pointer;">'
...
<div id='wrapper'>
	...
	<div>
        ...
        <div class="MYPAGE_CONTAINER">
            <div>
                <div class="user_name">
                    HELLO ( <b style="color: red;">${sessionScope.user_id }</b> )
                </div>
                <div class="user_menu">
                    <ul>
