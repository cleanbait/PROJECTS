...
var product_num = ${pv.product_num };
...
.buyspace .product_buy input[type=button] {
    padding: 5px;
    border: 1px solid;
    border-radius: 20px;
    background-color: white;
...
.buyspace .product_buy input[type=button]:hover {
	color: white;
	background-color: #2C1B01;
}
...
<div id='wrapper'>
    ...
    <div class="img_position">
		<img src=${pv.product_image }>
	</div>

    <div class="buyspace"> 
        <div class="product_detail">
            <h3>${pv.product_name }</h3>
            <textarea
			style= "width: 500px; height: 300px;
			resize: none; border: none; word-break:keep-all;
			background-color:#FFFFFF; color:white;"
			disabled
			placeholder="${pv.product_content }"></textarea>
        </div> 
        <div class="product_buy" id="product_buy">
            <h3> ${pv.product_price } ANA</h3>
            <!-- <p style="font-size: 12px">Quantity</p>
            <p><input type="number" value="1" min="1" style=width:40px;></p> -->
            <br><input type="button" value="Add to Cart" onclick="add(); cartCheck_re()">
            <input type="hidden" value="${pv.product_num }" id="add">
        </div>
    </div>
</div>
